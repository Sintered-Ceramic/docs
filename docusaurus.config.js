...
const config = {
  title: 'Sintered Ceramic',
  tagline: 'Uptime Guarantees for Ceramic Streams',
  favicon: 'img/sintered-ceramic-logo.png',

  // Set the production url of your site here
  url: 'https://sintered-ceramic.github.io',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Sintered Ceramic',
        logo: {
          alt: 'Sintered Ceramic',
          src: 'img/sintered-ceramic-logo.png',
        },
        items: [
          {
            type: 'docSidebar',
